...
export const DEMO_SECTION_CONTRACTS: readonly DemoSectionContract[] = [
  ...
  { id: 'badges', heading: 'Badges', presenceSelector: '.halo-badge', focusSelector: 'button' },
  { id: 'cards', heading: 'Cards', presenceSelector: '.halo-card', focusSelector: 'button' },
  { id: 'notices', heading: 'Notices', presenceSelector: '.halo-notice', focusSelector: 'button' },
  { id: 'expandable-panel', heading: 'Expandable Panel', presenceSelector: '.halo-expandable-panel', focusSelector: '.halo-expandable-panel__header-button' },
