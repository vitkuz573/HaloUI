...
- Release notes template (e.g., `.github/RELEASE_TEMPLATE.md` or `docs/releases/ReleaseNotes-template.md`) (drafted).
...
- Issue/PR templates updated to capture review checkpoints (`.github/ISSUE_TEMPLATE/uikit-work-item.md`, `.github/PULL_REQUEST_TEMPLATE.md`).
...
- _Deliverables_:
  - CI checklist integrated into repository; token validation + brand preview jobs added to `.github/workflows/ci.yml`.
  - Accessibility smoke workflow (`.github/workflows/accessibility.yml`) scaffolding Playwright+axe tests.
