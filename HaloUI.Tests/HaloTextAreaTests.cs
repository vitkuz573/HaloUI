...
public class HaloTextAreaTests : BunitContext
{
    ...
    public void RendersDisabledStateAndAttributes()
    {
        ...
        var wrapper = cut.Find("div.halo-textarea");
        Assert.Contains("halo-textarea", wrapper.ClassList);
        Assert.Contains("halo-textarea--disabled", wrapper.ClassList);
        ...
        Assert.Contains("halo-textarea__description", description.ClassList);
    }
